  ...
  var dashboard = new Vue({
    ...
    methods:{
      populateDataTable: function(){
        $("#extraVueContainer").load('admin/aboutus/who-we-are/list?'+new URLSearchParams(this.$data).toString(),function(responseTxt, statusTxt, xhr){
      ...
      addVueTemplete: function(){
        ...
        $('#extraVueContainer').load('admin/aboutus/who-we-are/add',function(responseTxt, statusTxt, xhr){
          if(statusTxt == 'success'){
            $('#extraVueContainer').html(responseTxt);
          }
          else if(statusTxt == 'error'){
      ...
      editVueTemplete: function(id){
        dashboard.add_btn = false;
        $('#extraVueContainer').load('admin/aboutus/who-we-are/edit?id='+id,function(responseTxt, statusTxt, xhr){
          if(statusTxt == 'success'){
            $('#extraVueContainer').html(responseTxt);
          }
          else if(statusTxt == 'error'){
      ...
      storeOrUpdate: function(postData){
        axios.post('admin/aboutus/who-we-are/storeOrUpdate', postData)
      ...
      delete: function(id){
        cuteAlert({
          ...
          // delete record  
          axios.post('admin/aboutus/who-we-are/delete', {
              id: id
          })
          .then(function (response) {
              cuteAlert({
